...
class ForwardNodeTests(unittest.TestCase):
  ...
  def test_init_value(self):
    value = 5.0
    trace = 1.0
    func = src.forwardNode.ForwardNode(value, trace=trace)
  ...
  def test_add_value(self):
    value = 5.0
    x = src.forwardNode.ForwardNode(value, trace=1.0)
    func = x + 2.0
  ...
  def test_arcsin_val(self):
    value = 0
    x = src.forwardNode.ForwardNode(value, trace=0)
    func = 2 * arcsin(x)
    assert func.value == 0
